...
#for the Other IDE platforms
app = dash.Dash(__name__)
server = app.server

#---------------------------------------------------------------
# Data was Taken from https://opendata.cityofnewyork.us/
df = pd.read_csv("Urban_Park_Ranger_Animal_Condition.csv")
#---------------------------------------------------------------
app.layout = html.Div([
                      #1
                    html.Div([ dcc.Graph(id='our_graph')],  className='six columns'),
                             #2                         #2
                                #3
                        html.Div([ html.Br(),
                                  ...
                                  dcc.Dropdown(id='my_dropdown',
                                        options=[  {'label': 'Species',             'value': 'Animal Class'},
                ...
                ## Properties of Dropdown: -
                               ...
                               #3               #'local': browser cookies are deleted
